...
# LATERAL SUPERIOR DIREITA ATE SEGUNDA LINHA - DEPOIS LINHA CENTRAL
# Finally, the prompt.
PROMPT='${PR_SET_CHARSET}${PR_STITLE}${(e)PR_TITLEBAR}\
${PR_BLUE}${PR_ULCORNER}(\
${PR_GREEN}%${PR_PWDLEN}<...<%~%<<\
${PR_GREY})$(ruby_prompt_info)${PR_BLUE}${PR_HBAR}${PR_HBAR}${(e)PR_FILLBAR}${PR_HBAR}${PR_BLUE}(\
${PR_CYAN}%(!.%SROOT%s.%n)${PR_GREEN}@%m:%l\
${PR_BLUE})${PR_HBAR}${PR_URCORNER}\

${PR_BLUE}${PR_LLCORNER}${PR_HBAR}(\
${PR_YELLOW}%D{%H:%M:%S}\
...
(${PR_YELLOW}%D{%a,%b%d}${PR_BLUE})${PR_HBAR}${PR_LRCORNER}${PR_NO_COLOUR}'
